...
PREMISSAS = [
    ...
    ("Carrego mensal", 559.0, MOEDA, "Condomínio mediano do bairro (R$ 399, n=20) + IPTU + consumo."),
    ...
    ("R$/m² de mercado", 5913.0, MOEDA, "Mediana de 13 anúncios de 2 dorm. entre 42 e 49 m² em Bela Vista, 23/09/2026."),
